...
# --- 3. カスタムCSS（設定は変えず、最後に「削除ボタン用」を追記） ---
st.markdown("""
    <style>
    ...
    h1, h2, h3, p, label, span, .stMarkdown, [data-testid="stMetricValue"], [data-testid="stWidgetLabel"] p { color: #000000 !important; }
    ...
    /* =========================================================
       ここから「追加」した削除ボタン専用スタイル
       ========================================================= */
    div[data-testid="stExpander"] .stButton > button {
        background-color: #EEEEEE !important; /* 明確なグレー背景 */
        border: 1px solid #999999 !important; /* 枠線を復活 */
